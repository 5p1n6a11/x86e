...
class readelf_l:
    def print_readelf_l(e_type, e_entry, e_phentsize, e_phnum, e_phoff, elf64_phdr, elf64_phdr_table):
        ...
        print("There are ", end="")
        print(e_phnum, end="")
        print(" program headers, starting at offset ", end="")
        print(e_phoff)

        print("")

        readelf_l.print_program_headers(elf64_phdr, elf64_phdr_table)

    def print_program_headers(elf64_phdr, elf64_phdr_table):
